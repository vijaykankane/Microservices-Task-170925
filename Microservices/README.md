...
# Test user endpoints (replace with actual endpoints)
...
# Test product endpoints (replace with actual endpoints)
...
# Test gateway routing (replace with actual endpoints)
...
1. **Terminal showing successful build**:
   ```bash
   docker-compose up -d --build
   ```

2. **Docker Desktop showing running containers**:
